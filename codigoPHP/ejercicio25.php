                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                            comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                            que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                                            <input class="d-flex justify-content-start" type="color" name="colorOpcional" value="<?php echo (isset($_REQUEST['colorOpcional']) ? $_REQUEST['colorOpcional'] : '');  ?>">
                                        </td>
                                        <td class="error">
                                            <?php if (!empty($aErrores['colorOpcional'])){ echo $aErrores['colorOpcional'];} ?> <!-- Aquí comprobamos que el campo del array '$aErrores' no esta vacío, si es así, mostramos el error. -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- Rango Opcional -->
