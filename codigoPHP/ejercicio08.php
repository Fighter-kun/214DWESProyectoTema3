...
<head>
  ...
  <meta name="description" content="CodigoEjercicio08">
  <meta name="keywords" content="CodigoEjercicio, 08">
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col text-center">
                     ...
                     * @since 11/10/2023
                     */
                    //Existe la variable predefinida $_SERVER que junto con el parametro 'REMOTE_ADDR' , nos indica la IP de nuestro equipo.
                    $ipCliente = $_SERVER['REMOTE_ADDR'];
                    echo("La dirección IP del equipo desde el que estás accediendo es: ".$ipCliente);
                    ?>
                </div>
            </div>
        </div>
